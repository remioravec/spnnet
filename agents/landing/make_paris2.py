...
def main() -> None:
    ...
    faq_new = (
        ...
        '    <details class="acc"><summary>À quelle fréquence faut-il nettoyer des bureaux ?<span class="pl">+</span></summary><div class="body">Cela dépend de votre effectif et de vos flux. La plupart des bureaux du 2ᵉ optent pour un passage quotidien ou 3 fois par semaine, avec un entretien renforcé (vitres, sols) mensuel. Nous calibrons la fréquence lors du devis.</div></details>\n'
        '    <details class="acc"><summary>Fournissez-vous les produits et le matériel ?<span class="pl">+</span></summary><div class="body">Oui, nos agents arrivent avec l\'ensemble des produits, consommables et équipements nécessaires. Vous n\'avez rien à gérer ni à stocker.</div></details>\n'
        '    <details class="acc"><summary>Vos produits sont-ils respectueux de l\'environnement ?<span class="pl">+</span></summary><div class="body">Oui : notre démarche RSE, reconnue par la médaille EcoVadis Argent, intègre des produits et protocoles responsables, avec une attention forte à la sécurité de nos agents.</div></details>\n'
        '    <details class="acc"><summary>Que se passe-t-il en cas d\'absence d\'un agent ?<span class="pl">+</span></summary><div class="body">Nous assurons systématiquement le remplacement pour garantir la continuité de la prestation — l\'avantage d\'une entreprise structurée plutôt que d\'un prestataire isolé.</div></details>\n'
        '    <details class="acc"><summary>Proposez-vous la vitrerie et l\'entretien des parties communes ?<span class="pl">+</span></summary><div class="body">Oui : vitrerie, sols, sanitaires, salles de réunion, tisanerie et parties communes font partie de nos prestations, en complément de l\'entretien courant des bureaux.</div></details>\n'
        '    <details class="acc"><summary>Faites-vous la remise en état ou le nettoyage de fin de bail ?<span class="pl">+</span></summary><div class="body">Oui, nous réalisons les grands nettoyages ponctuels : remise en état, fin de chantier, avant ou après un emménagement dans le 2ᵉ.</div></details>\n'
        '    <details class="acc"><summary>Gérez-vous les entreprises multi-sites ?<span class="pl">+</span></summary><div class="body">Oui, nous coordonnons l\'entretien de plusieurs sites avec un interlocuteur unique et un suivi centralisé.</div></details>\n'
        '    <details class="acc"><summary>Y a-t-il une durée d\'engagement ?<span class="pl">+</span></summary><div class="body">Le devis est sans engagement. Les contrats d\'entretien sont généralement annuels et ajustables ; nous en discutons selon vos besoins.</div></details>'
    )
    ...
    faq_ld = ('{"@context":"https://schema.org","@type":"FAQPage","mainEntity":['
              ...
              '{"@type":"Question","name":"A quelle frequence faut-il nettoyer des bureaux ?","acceptedAnswer":{"@type":"Answer","text":"Selon l\'effectif et les flux : souvent un passage quotidien ou 3 fois par semaine, avec vitres et sols renforces au mois. La frequence est calibree au devis."}},'
              '{"@type":"Question","name":"Fournissez-vous les produits et le materiel ?","acceptedAnswer":{"@type":"Answer","text":"Oui, les agents arrivent avec tous les produits, consommables et equipements. Rien a gerer de votre cote."}},'
              '{"@type":"Question","name":"Vos produits sont-ils ecologiques ?","acceptedAnswer":{"@type":"Answer","text":"Oui, notre demarche RSE (EcoVadis Argent) integre des produits et protocoles responsables."}},'
              '{"@type":"Question","name":"Que se passe-t-il en cas d\'absence d\'un agent ?","acceptedAnswer":{"@type":"Answer","text":"Le remplacement est assure systematiquement pour garantir la continuite de la prestation."}},'
              '{"@type":"Question","name":"Proposez-vous la vitrerie et les parties communes ?","acceptedAnswer":{"@type":"Answer","text":"Oui : vitrerie, sols, sanitaires, salles de reunion et parties communes, en plus de l\'entretien courant."}},'
              '{"@type":"Question","name":"Faites-vous la remise en etat ou fin de bail ?","acceptedAnswer":{"@type":"Answer","text":"Oui : grands nettoyages ponctuels, remise en etat, fin de chantier, avant ou apres emmenagement."}},'
              '{"@type":"Question","name":"Gerez-vous les entreprises multi-sites ?","acceptedAnswer":{"@type":"Answer","text":"Oui, plusieurs sites avec un interlocuteur unique et un suivi centralise."}},'
              '{"@type":"Question","name":"Y a-t-il une duree d\'engagement ?","acceptedAnswer":{"@type":"Answer","text":"Le devis est sans engagement ; les contrats sont generalement annuels et ajustables."}}'
              ']}')
